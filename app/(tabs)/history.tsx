...
const styles = StyleSheet.create({
  list: { gap: 12 },
  card: { borderWidth: 1, borderColor: COLORS.border, borderRadius: 18, backgroundColor: COLORS.card, overflow: 'hidden' },
  cardTitle: { color: COLORS.primaryStrong, fontSize: 17, fontWeight: '800' },
  ...
  count: { minWidth: 36, height: 36, borderRadius: 18, backgroundColor: COLORS.accent, alignItems: 'center', justifyContent: 'center' },
  countText: { color: COLORS.primaryStrong, fontSize: 14, fontWeight: '800' },
  attendees: { borderTopWidth: 1, borderTopColor: COLORS.border, padding: 14, gap: 12, backgroundColor: COLORS.primarySoft },
  ...
  empty: { minHeight: 180, borderWidth: 1, borderColor: COLORS.border, borderRadius: 18, backgroundColor: COLORS.card, alignItems: 'center', justifyContent: 'center', gap: 10 },
