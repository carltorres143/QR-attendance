...
const styles = StyleSheet.create({
  badge: { alignSelf: 'flex-start', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 6, backgroundColor: COLORS.accent },
  badgeText: { color: COLORS.primaryStrong, fontSize: 12, fontWeight: '800', letterSpacing: 1.2 },
  details: { borderWidth: 1, borderColor: COLORS.border, borderRadius: 18, backgroundColor: COLORS.card, overflow: 'hidden' },
  row: { padding: 16, borderBottomWidth: 1, borderBottomColor: COLORS.border, gap: 8 },
  ...
  editLabel: { color: COLORS.primary, fontSize: 14, fontWeight: '800', textDecorationLine: 'underline' },
  editBlock: { gap: 12 },
